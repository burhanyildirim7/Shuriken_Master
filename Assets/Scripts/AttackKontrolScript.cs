            ...
            if (_attackAktif)
            {
                if (_timer > _attackHizi)
                {
                    ...
                    if (_standartAttack)
                    {
                        ...
                        shuriken.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                    }
                    else if (_ikiliAttack)
                    {
                        ...
                        shuriken1.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken2.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                    }
                    else if (_ucluAttack)
                    {
                        ...
                        shuriken1.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken2.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken3.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                    }
                    else if (_besliAttack)
                    {
                        ...
                        shuriken2.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken3.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken4.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                        shuriken5.GetComponent<ShurikenKontrolScript>()._damage = 10 + (PlayerPrefs.GetInt("PowerLevelDegeri") * 10);
                    }
                    else
                    {
